...
const DetailProduct = () => {
  ...
  const showAnotherImageProduct = () => {
    ...
    const changeMainImage = (image_position) => {
      ...
      let srcImageNormalResolution = document.getElementById(
        "detail__image-highResolution"
      ).src;

      srcImageHighResolution = srcImageHighResolution.replace(
        "ImageAllProducts",
        "ImageAllProductsHighResolution"
      );
      srcImageHighResolution = srcImageHighResolution.replace(
        ".png",
        "_high_resolution.png"
      );

      srcImageNormalResolution = srcImageNormalResolution.replace(
        "ImageAllProductsHighResolution",
        "ImageAllProducts"
      );
      srcImageNormalResolution = srcImageNormalResolution.replace(
      ...
      document.getElementById("detail__image-highResolution").src =
        srcImageHighResolution;
    };

    console.log(showAllAnotherImage);
