...
// import ImageProduct from "../../../assets/images/ImageAllProducts/product_1/product_1_1.png";

const DetailProduct = () => {
  const { state } = useLocation();
  console.log(state["imageProduct"]);
  const linkImageProduct =
    "../../../assets/images/ImageAllProducts/product_1/product_1_1.png";
  //   const a = require(state["imageProduct"]);
  return (
    <div>
      <img src={"" + require(linkImageProduct)}></img>
      ...
      <div class="detail__product">
        <div class="detail__productInner">
          <div class="detail__image">
            ...
            {/* id="detail__image-highResolution" // alt="Hình ảnh chính" // /> */}
