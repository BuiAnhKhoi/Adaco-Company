      ...
      elementAllProduct.push(
        <div class="card__item">
          ...
          <p>
            <a href="index.html">
              {
                json["product_" + productFilterArray[index][0]][
                  "product_" + productFilterArray[index][0] + "_name"
                ]
              }
            </a>
          </p>
          <h3>
            {
              json["product_" + productFilterArray[index][0]][
                "product_" + productFilterArray[index][0] + "_price"
              ]
            }
          </h3>
        </div>
