...
const AllProduct = () => {
  ...
  function showAllProduct(filterPara) {
    ...
    console.log(productFilterArray[0][0]);
    ...
    for (let index in productFilterArray) {
      elementAllProduct.push(
        <div class="card__item">
          ...
          <p>
            <a href="index.html">
              {json["product_" + index[0]]["product_" + index[0] + "_name"]}
            </a>
          </p>
          <h3>
            {/* {json["product_" + indexJson]["product_" + indexJson + "_price"]} */}
    ...
    // } else if (currentFilter === "Price Top - Down") {
    //   console.log(elementAllProduct);
    // } else if (currentFilter === "Price Down - Top") {
    //   console.log("b");
    // }
  }
